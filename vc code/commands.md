...
- подробно опиши "user story" и сохрани в @/docs/memory-bank/user_stor по каждую задачам разработки следующей фазы в файлах в подпапке "user_story"  - одна доработка одна user story
